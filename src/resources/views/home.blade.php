{{-- The home can also be the layout for the customer --}}
...
<body class="home">
    ...
    {{-- Header --}}
    @include ('subcomponents.usernav')

    {{-- Hero Section --}}
    <section class="hero bg-image header">
    ...
    @if (Route::is('home'))
        @include('subcomponents.categories')
    @elseif (Route::is('register'))
        @include('subpages.register')
    @elseif (Route::is('login'))
        @include('subpages.login')
    @elseif (Route::is('dashboard'))
        @include('subpages.dashboard')
    @elseif (Route::is('orders'))
        @include('subpages.orders')
    @elseif (Route::is('menu'))
        @include('subpages.dishes')
    @elseif (Route::is('dish.category'))
        @include('subpages.viewdishes')
    @elseif (Route::is('records'))
        @include('subpages.records')
    @endif
